TokoVoipConfig = {
	...
	wsServer = "149.202.65.94:33250", -- Address of the websocket server
	...
	plugin_data = {
		...
		TSChannel = "EN VILLE",
		TSPassword = "wl13", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "Arrive en ville", -- You NEED tokovoip in the wait channel name!

		-- Blocking screen informations
		TSServer = "149.202.65.94", -- TeamSpeak server address to be displayed on blocking screen
