            ...
            for i = 1, #Mapper.Objects, 1 do
                if Mapper.Objects[i] ~= nil then
                    local distance =
                        ...
                        coords.y,
                        coords.z,
                        Mapper.Objects[i].pos.x,
                        Mapper.Objects[i].pos.y,
                        Mapper.Objects[i].pos.z,
                        true
                    )
...
Citizen.CreateThread(
    function()
        while true do
            ...
            if
                Mapper.Editor.Started and IsControlPressed(0, Keys["LEFTCTRL"]) and
                    IsControlJustReleased(0, Keys["SPACE"])
             then
