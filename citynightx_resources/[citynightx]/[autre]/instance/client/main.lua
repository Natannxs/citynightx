...
TriggerEvent('instance:registerType', 'labos',
  function(instance)
    exports["Citynight"]:EnterLabos()
  end,
  function(instance)
    exports["Citynight"]:ExitLabos()
  end
)
...
TriggerEvent('instance:registerType', 'property',
  function(instance)
    exports["Citynight"]:EnterAppart()
  end,
  function(instance)
    exports["Citynight"]:ExitAppart()
  end
)
...
AddEventHandler("getInstanceHost",function(cb)
	cb(Instance.host)
