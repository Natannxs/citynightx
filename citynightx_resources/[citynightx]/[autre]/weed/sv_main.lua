...
AddEventHandler("createWeed",function(c)
...
AddEventHandler("createWeed2",function(coords,table)
...
AddEventHandler("removeWeed",function(d)
    weeds[d] = nil
...
AddEventHandler("editWeed",function(i,n)
...
AddEventHandler("getWeeds",function()
...
Citizen.CreateThread(function()
    while true do
        ...
        for k , v in pairs(weeds) do
            ...
            if v.percent > 100 then v.percent = 100.0 end
