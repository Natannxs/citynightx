...
RegisterNUICallback(
    ...
    function()
        ...
        exports["Citynight"]:deleteRandomItem("water")
...
RegisterNUICallback(
    ...
    function()
        for i = 1, math.random(10, 28), 1 do
            ...
            exports["Citynight"]:AddItemtoInv(items)
        end
        SetNuiFocus(0, 0)
        inNUI = false
        SendNUIMessage({action = "hide", data = v})
...
RegisterNUICallback(
    ...
    function()
        ...
        local v = current
        SendNUIMessage({action = "data", data = {water = v.water, percent = v.percent, fertz = v.fertz}})
        exports["Citynight"]:deleteRandomItem("fertz")
                        ...
                        SendNUIMessage(
                            {
                                ...
                                items = {
                                    water = exports["Citynight"]:GetItemCount("water"),
                                    fertz = exports["Citynight"]:GetItemCount("fertz")
                                }
                            }
                        )
                        SetNuiFocus(1, 1)
