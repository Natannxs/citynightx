...
cfg = {
	...
	sundayDriverAcceleratorCurve = 6.5,			-- The response curve to apply to the accelerator. Range 0.0 to 10.0. Higher values enables easier slow driving, meaning more pressure on the throttle is required to accelerate forward. Does nothing for keyboard drivers
...
repairCfg = {
	...
	fixMessages = {
		...
		"Vous avez serré la vis du carter d'huile et arrêté les écoulements",
	...
	noFixMessages = {
		...
		"Vous avez regardé votre moteur, il semblait aller bien",
		"Vous vous êtes assuré que la bande adhésive retenait toujours le moteur",
		"Vous avez augmenté le volume de la radio. Il a juste noyé les bruits étranges du moteur",
		"Vous avez ajouté un anti-rouille au tube d'allumage. Cela n'a fait aucune différence",
		"Ne répare jamais quelque chose qui n'est pas cassé, ont-ils dit. Tu n'as pas écouté. Au moins, ça n'a pas empiré"
	},
	noFixMessageCount = 6
}

RepairEveryoneWhitelisted = true --si true chacun peut effectuer une mini réparation en faisant /repair..
RepairWhitelist =
{
	"steam:110000119e2c7db",
	"steam:1100001094bb519"	
}
