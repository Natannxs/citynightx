...
-- 		if (IsControlJustPressed(1, 0) and IsControlJustPressed(1, 0)) then
-- 			if group ~= "user" then
...
AddEventHandler(
    ...
    function(t, target)
        ...
        if t == "noclip" then
            ...
            TriggerEvent("chatMessage", "VLife", {255, 0, 0}, "Noclip a été ^2^*" .. msg)
        end
        if t == "freeze" then
...
AddEventHandler(
    ...
    function()
        ...
        TriggerEvent("chatMessage", "VLife", {255, 0, 0}, "Position enregistrée dans le fichier.")
    end
)
...
AddEventHandler(
    ...
    function(t)
        ...
        TriggerEvent("chatMessage", "VLife", {255, 0, 0}, "Noclip à été ^2^*" .. msg)
    end
)
