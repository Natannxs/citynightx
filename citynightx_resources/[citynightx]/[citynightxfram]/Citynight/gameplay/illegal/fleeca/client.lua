...
--                 while true do
--                     if
--                         Job:Get() ~= nil and Job:Get().name ~= nil and
--                             (Job:Get().name == "police" or Job:Get().name == "lssd") and
--                             not dooruse
--                      then
...
--         end
--         Check[name] = false
--         ShowNotification("~r~Attention les portes vont se fermer dans 30 secondes~s~")
--         Citizen.Wait(30000)
...
--         ShowNotification("~y~Vous utilisez votre fause carte d'accès~s~")
--         Citizen.Wait(1500)
...
--         disableinput = false
--         Citizen.Wait(1000)
--         Process(UTK.hacktime, "Piratage en cours... (30 secondes)")
...
--         ShowNotification("~g~Vous avez désormais 2 minutes avant que le systeme de sécurité s'active~s~")
...
--     )
--     TaskStartScenarioInPlace(ped, "PROP_HUMAN_ATM", 0, true)
--     ShowNotification("~y~Vous utilisez votre fausse carte d'accès~w~")
--     Citizen.Wait(1500)
...
--     ClearPedTasksImmediately(ped)
--     disableinput = false
--     Process(UTK.hacktime, "Vous piratez la seconde porte (30 secondes)")
...
--     local players, nearbyPlayer = FleecaGetPlayersInArea(GetEntityCoords(PlayerPedId()), 20.0)
--     local missionplayers = {}

--     TriggerServerEvent(
--         "call:makeCall2",
--         "police",
--         {x = data.trolley1.x, y = data.trolley1.y, z = data.trolley1.z},
--         "\n[FLEECA]\n ~r~" .. #players .. " individu(s) est/sont en train de piller le coffre de notre banque~s~"
--     )
--     TriggerServerEvent(
--         "call:makeCall2",
--         "lssd",
...
--                         UTK.Banks[currentname].doors.secondloc.y,
--                         UTK.Banks[currentname].doors.secondloc.z,
--                         "[~r~E~w~] Utiliser la fausse carte",
--                         0.40
--                     )
--                     if dst < 0.75 and IsControlJustReleased(0, 38) then
--                         local count = Inventory:GetItemCount("employeecard2")

--                         if (count > 0) then
--                             Inventory:RemoveItemToInv(
--                                 Inventory.Inventory["employeecard2"][1].id,
--                                 Inventory.Inventory["employeecard2"][1].name
--                             )
--                             done = true
--                             SecondDoor(UTK.Banks[currentname], currentname)
--                         else
--                             ShowNotification("~r~Vous n'avez pas la masterKey du banquier~s~")
--                         end
--                     end
--                 end
...
--                         if
--                             Job:Get() ~= nil and Job:Get().name ~= nil and
--                                 (Job:Get().name ~= "police" and Job:Get().name ~= "lssd") and
--                                 not dooruse
--                          then
--                             DrawText3D(
--                                 v.doors.startloc.x,
...
--                                 local count = Inventory:GetItemCount("employeecard")
--                                 if (count > 0) then
--                                     TriggerServerCallback(
--                                         "service:Count",
--                                         function(nbpolice)
...
--                                                         Inventory:RemoveItemToInv(
--                                                             Inventory.Inventory["employeecard"][1].id,
--                                                             Inventory.Inventory["employeecard"][1].name
--                                                         )
--                                                     else
...
--                                     )
--                                 else
--                                     ShowNotification("~r~Vous n'avez aucune carte valide~s~")
--                                 end
--                             end
--                         end
--                     end
