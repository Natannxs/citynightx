...
local globalWeaponTable = {
    blanc = {
        ...
        {"WEAPON_KNIFE", "Couteau", 350},
        {"WEAPON_SWITCHBLADE", "Couteau pliant", 350},
        {"WEAPON_HAMMER", "Marteau", 250},
        {"WEAPON_BAT", "Batte", 300},
        {"WEAPON_CROWBAR", "Pied de biche", 400}
    },
    pistol = {
        {"WEAPON_PISTOL", "Pistolet", 9999999},
    }
}
                ...
                RageUI.DrawContent(
                    ...
                    function()
                        ...
                        RageUI.Button(
                            ...
                            function(_, _, Selected)
                                if Selected then
                                    local receive = Inventory.CanReceive("mm9", amount_index)
                                    if receive then
                                        dataonWait = {
                                            price = amount_index * 2,
                                            fct = function()
                                                for i = 1, amount_index, 1 do
                                                    Inventory:AddItemToInv(munition_name[munition_index])
                                                end
