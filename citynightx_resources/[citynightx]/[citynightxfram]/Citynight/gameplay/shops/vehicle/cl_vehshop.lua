local VehShop =
    setmetatable(
    {
        -- veh
        {
            ...
            Vehicles = {
                ["Entreprise"] = {
                    {name = "ambulance", price = 20000},
                    {name = "sheriff2", price = 20000},
                    {name = "police", price = 20000},
                    {name = "police2", price = 20000},
                    {name = "police3", price = 20000},
                    {name = "police4", price = 20000},
                    {name = "policeb", price = 20000},
                    {name = "rumpo", price = 20000},
                    {name = "policet", price = 20000}
                },
                ["Compacts"] = {
                ...
                ["Motos"] = {
                    {name = "akuma", price = 11200},
                    {name = "avarus", price = 10500},
                    {name = "bagger", price = 16100},
                    {name = "bati", price = 14000},
                    {name = "bati2", price = 16800},
                    {name = "bf400", price = 9600},
                    {name = "carbonrs", price = 14000},
                    {name = "chimera", price = 21000},
                    {name = "cliffhanger", price = 8400},
                    {name = "daemon", price = 5600},
                    {name = "daemon2", price = 6000},
                    {name = "diablous", price = 10500},
                    {name = "diablous2", price = 11900},
                    {name = "defiler", price = 9000},
                    {name = "double", price = 14000},
                    {name = "enduro", price = 6000},
                    {name = "esskey", price = 5400},
                    {name = "fcr", price = 5100},
                    {name = "fcr2", price = 5100},
                    {name = "faggio", price = 1600},
                    {name = "faggio2", price = 3200},
                    {name = "faggio3", price = 4500},
                    {name = "gargoyle", price = 10500},
                    {name = "hakuchou", price = 17500},
                    {name = "hakuchou2", price = 35000},
                    {name = "hexer", price = 7800},
                    {name = "innovation", price = 14000},
                    {name = "lectro", price = 6300},
                    {name = "nemesis", price = 6000},
                    {name = "nightblade", price = 12600},
                    {name = "manchez", price = 6000},
                    {name = "pcj", price = 4800},
                    {name = "ratbike", price = 5700},
                    {name = "ruffian", price = 5400},
                    {name = "sanchez", price = 5100},
                    {name = "sanchez2", price = 5400},
                    {name = "sanctus", price = 8450},
                    {name = "sovereign", price = 16100},
                    {name = "thrust", price = 14000},
                    {name = "vader", price = 6000},
                    {name = "vortex", price = 7500},
                    {name = "wolfsbane", price = 7200},
                    {name = "zombiea", price = 7000},
                    {name = "zombieb", price = 7700}
                },
                ["Quad"] = {
                    {name = "blazer", price = 5700},
                    {name = "blazer2", price = 5000},
                    {name = "blazer3", price = 9100},
                    {name = "blazer4", price = 7500}
                },
                ["4x4"] = {
