...
--     local blip = AddBlipForCoord(-550.06,-190.23,37.32)
...
--     AddTextComponentString("Jobs.gouv")
--     EndTextCommandSetBlipName(blip)
--     Zone:Add({x=-550.06,y=-190.23,z=37.32,a=182.56},JobListing.EnterZone,JobListing.ExitZone,nil,2.5)
--     Ped:Add("Marc","ig_bankman",{x=-550.06,y=-190.23,z=37.32,a=182.56},nil)
