...
RegisterServerEvent("Citynight_bank:removeMoneyFromBankAccount")
AddEventHandler(
...
RegisterServerEvent("Citynight_bank:addMoneyToBankAccount")
AddEventHandler(
...
RegisterServerEvent("Citynight_bank:addRemoveQuotaToCard")
AddEventHandler(
...
RegisterServerEvent("Citynight_bank:addDepositQuotaToCard")
AddEventHandler(
