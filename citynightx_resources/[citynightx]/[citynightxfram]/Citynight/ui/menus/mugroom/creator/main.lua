                ...
                RageUI.DrawContent(
                    ...
                    function()
                        ...
                        RageUI.List(
                            ...
                            spawnPoint.data,
                            spawnPoint.index,
                            "Le lieu sur lequel vous allez faire vos premiers pas sur l'île.",
                            {},
                            true,
                            function(Hovered, Active, Selected, Index)
                        ...
                        RageUI.Button(
                            ...
                            function(Hovered, Active, Selected)
                                if Selected then
                                    ...
                                    if
                                        (createPlayer[createPlayer.Model].Identity.first_name ~= nil and
                                            createPlayer[createPlayer.Model].Identity.last_name ~= nil and
                                            createPlayer[createPlayer.Model].Identity.birth_date ~= nil and
                                            createPlayer[createPlayer.Model].Identity.origine ~= nil)
                                     then
                                        Inventory:Load()
                                        Wait(500)
                                        GiveClothes()
