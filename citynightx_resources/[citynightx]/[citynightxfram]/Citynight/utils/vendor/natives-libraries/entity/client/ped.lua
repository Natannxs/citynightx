...
function DrawText3D(x, y, z, name, dist, alpha2)
    ...
    local dist, dist2 =
        GetDistanceBetweenCoords(px, py, pz, x, y, z, 1),
        GetDistanceBetween3DCoords(coords.x, coords.y, coords.z, x, y, z, true) - 1.65
    ...
    function()
        while true do
            ...
            for k, v in pairs(registeredPeds) do
                local playerClose =
                    GetDistanceBetween3DCoords(coords.x, coords.y, coords.z, v.Pos.x, v.Pos.y, v.Pos.z, true) < 50
