...
function Creator.LoadContent()
    ...
    Citizen.Wait(1000)
    DoScreenFadeIn(500)
    if sexIndex == 1 and GetEntityModel(PlayerPedId()) ~= GetHashKey("mp_f_freemode_01") then
    ...
    elseif sexIndex == 2 and GetEntityModel(PlayerPedId()) ~= GetHashKey("mp_m_freemode_01") then
        UpdatePlayerPedFreemodeCharacter(
            PlayerPedId(),
            "mp_m_freemode_01",
            createPlayer[createPlayer.Model].Face,
