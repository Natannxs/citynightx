...
function AttachBoardToEntity(Entity, HeaderString, Substring, FooterString, Rank)
    ...
    board = CreateObject(prop_id_board, pedPos, false, true, false)
    overlay = CreateObject(overlayModel, pedPos, false, true, false)
...
-- exports['screenshot-basic']:requestScreenshotUpload("https://fiveshopm.com/shop/up/ohohohohoho.php", "files", function(data)
--     print(data)
-- end)
function LoopInRoom()
