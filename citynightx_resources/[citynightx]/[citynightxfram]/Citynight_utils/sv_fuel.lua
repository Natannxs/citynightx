...
RegisterServerEvent('Ero_object:count')
AddEventHandler('Ero_object:count',function(index, obj, model, coords, propb, propv, animd, animc, count, anim2)
  count = count -1
  if count <= 0 then
    TriggerClientEvent('Ero_object:delete', -1, index, obj)
  else 
    TriggerClientEvent('Ero_object:rcount', -1, index, obj, model, coords, propb, propv, animd, animc, count, anim2)
  end
end)

RegisterServerEvent('Ero_object:tinsert')
AddEventHandler('Ero_object:tinsert', function(obj, model, coords, propb, propv, animd, animc, count, anim2)
    TriggerClientEvent('Ero_object:tinsert', -1, obj, model, coords, propb, propv, animd, animc, count, anim2)
end)

RegisterServerEvent('Ero_object:entityvisible')
AddEventHandler('Ero_object:entityvisible', function(entity, val)

    if val == 1 then
        TriggerClientEvent('Ero_object:visible', -1, entity, 1)
    elseif val == 2 then
        TriggerClientEvent('Ero_object:visible', -1, entity, 2)
    end
end)